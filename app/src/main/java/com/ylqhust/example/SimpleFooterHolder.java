...
import com.ylqhust.pullrefresh.FooterHolder;
...
public class SimpleFooterHolder extends FooterHolder {
    ...
    private void initView(View v) {
        this.v = v;
        arrow = (ImageView) v.findViewById(R.id.pullrefresh_footer_img_status);
        progressBar = (ProgressBar) v.findViewById(R.id.pullrefresh_footer_progressbar);
        tvStatus = (TextView) v.findViewById(R.id.pullrefresh_footer_tv_status);
        result = (ImageView) v.findViewById(R.id.pullrefresh_footer_img_result);
    }
